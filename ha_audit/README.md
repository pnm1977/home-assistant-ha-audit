...
Detailed audit data is stored alongside the summary in JSON reports.
...
For normal use, begin with the **CURRENT RUN SUMMARY** in:

**Settings → Apps → HA Audit → Log**

Only open the detailed files when the summary or **NEXT ACTIONS** section directs you to them.
